...
#define RGB_ENTRY(name,val,reg) { { get_rgb_entry, set_rgb_entry, init_rgb_entry, COLORS_KEY, reg }, (val) }
    ...
    RGB_ENTRY( COLOR_MENU, RGB(255, 255, 255), L"Menu" ),
    ...
    RGB_ENTRY( COLOR_BTNFACE, RGB(255, 255, 255), L"ButtonFace" ),
    ...
    RGB_ENTRY( COLOR_ALTERNATEBTNFACE, RGB(255, 255, 255), L"ButtonAlternateFace" ),
    ...
    RGB_ENTRY( COLOR_MENUBAR, RGB(255, 255, 255), L"MenuBar" )
#undef RGB_ENTRY
};
