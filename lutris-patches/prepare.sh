...
if [ $MFPLAT_PATCH = 1 ]; then
    ...
    echo "mfplat dll register patch"
    ...
    echo "mfplat nier replicant patch"
    ...
    echo "mfplat video conversion patches"
